<x-layouts::app :title="__('Correo_1')">
    @php
        $estudiantes = [
            ['nombre' => 'Ana García', 'edad' => 20, 'carrera' => 'Ingeniería'],
            ['nombre' => 'Luis Pérez', 'edad' => 22, 'carrera' => 'Mediciona'],
    ...
    <div class="space-y-6">
        <div class="rounded-xl border border-neutral-200 dark:border-neutral-700 p-6">
            <h1 class="text-2xl font-bold">Listado de estudiantes Correo 1</h1>
            <p class="text-sm text-neutral-600 dark:text-neutral-300">
                Vista independiente correspondiente al botón correo1.
            </p>
        </div>
